const {
  ...
  class NewPopularController {
    getNewonNetflix(req, res) {
      res.send(data);
    }

    getTop10TVShowsTodaybyCountry(req, res) {
      res.send(data);
    }

    getTop10MoviesTodaybyCountry(req, res) {
      res.send(data);
    }
    getComingNextWeek(req, res) {
      res.send(data);
    }
    getWorththeWait(req, res) {
      res.send(data);
    }
    getComingThisWeek(req, res) {
      res.send(data);
    }
  }
  module.exports = new NewPopularController();
