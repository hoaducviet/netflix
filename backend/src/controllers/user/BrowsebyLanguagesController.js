...
class BrowsebyLanguagesController {
  getMoviesbyOriginal(req, res) {
    res.send(data);
  }

  getMoviesbyAudio(req, res) {
    res.send(data);
  }
  getMoviesbySubtitles(req, res) {
    res.send(data);
  }
}
module.exports = new BrowsebyLanguagesController();
